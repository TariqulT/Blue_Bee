	...
	<div class="contentsection contemplete clear">
		<div class="maincontent clear">
			...
			if(isset($_GET['category'])){
				...
				$sql    = "SELECT * FROM tbl_post WHERE cat=$category LIMIT $start_from, $per_page";
			...
			<?php
					...
					echo "<a href='posts.php?page=$total_page&category=$category'>Last page</a></span>";
					// Pagination
				}
				else{
					...
					$result = $db->select($sql);
					if($result){
						echo "No post available for the selected category";
					}
					else{
